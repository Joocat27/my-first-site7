...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-0-1762432208268.png","video":"","title":"구글맵 리뷰 기반 도시공원 인식 비교","description":"구글맵 리뷰 기반 도시공원 인식 비교\n내국인 vs 외국인의 도시 이미지 분석\n텍스트마이닝과 사회연결망 분석 활용"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
