...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교 부동산건설대학원 도시 및 부동산 개발 2024-2026","period":"경희대 식품공학 1998-2023","description":""},{"icon":"award","title":"Lic Ac 11193","period":"","description":"설명을 입력하세요"}],
    skills: [],
    storyTitle: "나의 이야기",
    story: ["호기심 많은 사람...과도한 호기심으로 지금은 텍스트 마이닝 삼매경..."],
    storyImage: "",
    hobbies: ["🏃 러닝","🎯 테니스"]
  }
