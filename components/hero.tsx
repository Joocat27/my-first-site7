...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"새 링크https://www.youtube.com/@hivytv","icon":"globe","url":"https://www.youtube.com/@hivytv"}]
  
  const defaultInfo = {
    greeting: "어제보다 더 좋은 하루죠?",
    name: "유주희 Joo Yoo",
    title: "미국에서 거주 후 한국에 정착하여         도시개발과 텍스트마이닝을 연구하는 석사과정생입니다.",
    description: "텍스트 마이닝으로 데이터를 분석\n마음을 읽는 사람이 되고 싶은",
    profileImage: "/uploads/hero-profile-1762051434143.jpg",
    backgroundImage: "",
    backgroundVideo: "",
