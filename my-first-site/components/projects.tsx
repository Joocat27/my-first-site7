...
export function Projects() {
  return (
    <section className="py-16 bg-blue-50 text-center">
      <h2 className="text-3xl font-semibold text-gray-800 mb-8">Research & Projects</h2>
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow p-6">
          <h3 className="text-xl font-bold text-gray-700">서울 주요 공원의 인식 비교 연구</h3>
          <p className="text-gray-500 mt-2 text-sm">
            구글맵 리뷰 기반 텍스트마이닝으로 남산공원·서울숲·반포한강공원에서 
            내국인과 외국인의 감성 차이를 분석.
          </p>
        </div>

        <div className="bg-white rounded-2xl shadow p-6">
          <h3 className="text-xl font-bold text-gray-700">Korami 정착 컨설팅 플랫폼</h3>
          <p className="text-gray-500 mt-2 text-sm">
            해외 교포 및 외국인에게 한국 정착 관련 정보를 제공하는 
            웹앱 기획 — 부동산, 의료보험, 운전면허 등 필수정보 제공.
          </p>
        </div>
      </div>
    </section>
